...
2. **Discovery:** Profile -> `backend/discover-jobs` (Streaming SSE) -> Firecrawl Job Search (LinkedIn/Naukri) -> Jina JD Scraping -> Groq Validation -> Serper Profile Search -> Hunter Email Lookup.
